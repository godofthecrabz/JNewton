...
public class NewtonWorldConvexCastReturnInfo {
    ...
    ).withName("crab.newton.NewtonWorldConvexCastReturnInfo");
    ...
    public static MemoryAddress m_hitBody$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonWorldConvexCastReturnInfo.m_hitBody$VH.get(seg);
    }
    ...
    public static MemoryAddress m_hitBody$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonWorldConvexCastReturnInfo.m_hitBody$VH.get(seg.asSlice(index*sizeof()));
    }
