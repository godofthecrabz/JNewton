...
public class NewtonMeshDoubleData {
    ...
    ).withName("crab.newton.NewtonMeshDoubleData");
    ...
    public static MemoryAddress m_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonMeshDoubleData.m_data$VH.get(seg);
    }
    ...
    public static MemoryAddress m_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonMeshDoubleData.m_data$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress m_indexList$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonMeshDoubleData.m_indexList$VH.get(seg);
    }
    ...
    public static MemoryAddress m_indexList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonMeshDoubleData.m_indexList$VH.get(seg.asSlice(index*sizeof()));
    }
