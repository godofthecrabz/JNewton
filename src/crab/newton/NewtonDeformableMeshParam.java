...
public class NewtonDeformableMeshParam {
    ...
    ).withName("crab.newton.NewtonDeformableMeshParam");
    ...
    public static MemoryAddress m_indexList$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonDeformableMeshParam.m_indexList$VH.get(seg);
    }
    ...
    public static MemoryAddress m_indexList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonDeformableMeshParam.m_indexList$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress m_vertexList$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonDeformableMeshParam.m_vertexList$VH.get(seg);
    }
    ...
    public static MemoryAddress m_vertexList$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonDeformableMeshParam.m_vertexList$VH.get(seg.asSlice(index*sizeof()));
    }
