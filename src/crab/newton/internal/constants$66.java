...
public class constants$66 {
    ...
    public static final MethodHandle NewtonBodySetUserData$MH = RuntimeHelper.downcallHandle(
        ...
        constants$66.NewtonBodySetUserData$FUNC
    );
    ...
    public static final MethodHandle NewtonBodyGetUserData$MH = RuntimeHelper.downcallHandle(
        ...
        constants$66.NewtonBodyGetUserData$FUNC
    );
    ...
    public static final MethodHandle NewtonBodyGetWorld$MH = RuntimeHelper.downcallHandle(
        "NewtonBodyGetWorld",
        constants$66.NewtonBodyGetWorld$FUNC
    );
    ...
    public static final MethodHandle NewtonBodyGetCollision$MH = RuntimeHelper.downcallHandle(
        ...
        constants$66.NewtonBodyGetCollision$FUNC
    );
    ...
    public static final MethodHandle NewtonBodyGetMaterialGroupID$MH = RuntimeHelper.downcallHandle(
        ...
        constants$66.NewtonBodyGetMaterialGroupID$FUNC
    );
    ...
    public static final MethodHandle NewtonBodyGetSerializedID$MH = RuntimeHelper.downcallHandle(
        ...
        constants$66.NewtonBodyGetSerializedID$FUNC
    );
}
