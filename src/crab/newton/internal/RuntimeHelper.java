...
public final class RuntimeHelper {
    ...
    public static final void loadLibrary(String filepath) {
    ...
    public static final <Z> NativeSymbol upcallStub(Class<Z> fi, Z z, FunctionDescriptor fdesc, String mtypeDesc, ResourceScope scope) {
        try {
    ...
    public static MemorySegment asArray(MemoryAddress addr, MemoryLayout layout, int numElements, ResourceScope scope) {
