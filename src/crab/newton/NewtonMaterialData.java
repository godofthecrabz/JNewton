...
public class NewtonMaterialData {
    ...
    public static MemoryAddress m_ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonMaterialData.m_ptr$VH.get(seg);
    }
    ...
    public static MemoryAddress m_ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonMaterialData.m_ptr$VH.get(seg.asSlice(index*sizeof()));
    }
