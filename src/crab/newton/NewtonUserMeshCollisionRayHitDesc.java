...
public class NewtonUserMeshCollisionRayHitDesc {
    ...
    ).withName("crab.newton.NewtonUserMeshCollisionRayHitDesc");
    ...
    public static MemoryAddress m_userData$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)NewtonUserMeshCollisionRayHitDesc.m_userData$VH.get(seg);
    }
    ...
    public static MemoryAddress m_userData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)NewtonUserMeshCollisionRayHitDesc.m_userData$VH.get(seg.asSlice(index*sizeof()));
    }
